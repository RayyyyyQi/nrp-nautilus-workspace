...
NS=tianhaowang-ucsd
JOB=fig4c-k300-steps200-tuned-eta-0721
CM=fig4c-k300-steps200-code-0721
HELPER=pvc-copy-helper
REMOTE=/mnt/results/fig4_wang2509/7_21/nautilus/fig4c_K300_steps200_tuned_eta
LOCAL_FIG=experiments/fig4_wang2509/figures/7_21/nautilus
...
if ! kubectl -n "${NS}" get job "${JOB}" >/dev/null 2>&1; then
  kubectl apply -f experiments/fig4_wang2509/k8s/fig4c-k300-steps200-tuned-eta-0721.yaml
fi
...
kubectl -n "${NS}" cp "${HELPER}:${REMOTE}/fig4c_K300_steps200_tuned_eta_nautilus.csv" "${LOCAL_RESULT}/fig4c_K300_steps200_tuned_eta_nautilus.csv"
for figure in fig4c_K300_steps200_tuned_eta_normal_nautilus.png fig4c_K300_steps200_tuned_eta_precision1e-16_nautilus.png; do
